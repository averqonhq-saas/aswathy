...
export const DEFAULT_SESSION_FORMATS: SessionFormat[] = [
  ...
  {
    id: "in-person-studio",
    title: "In-Person Studio Session",
    format: "in-person",
    duration: "60 Minutes · Private Studio",
    tag: "Studio Sanctuary",
    badge: "In-Person",
    badgeType: "in-person",
    description:
      "A quiet, sunlit physical therapy space designed for grounding, somatic safety, and calm connection.",
    icon: "studio",
    price: 2000,
    order: 2,
    isActive: true,
